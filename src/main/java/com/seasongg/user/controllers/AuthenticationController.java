...
public class AuthenticationController extends CommonController {
    ...
    public ResponseEntity<?> login(@RequestBody AuthenticationRequest authenticationRequest) {
        ...
        try {
            ...
            return new ResponseEntity<>(new RestResponse(SggService.UNKNOWN_ERROR,
    ...
    public ResponseEntity<?> register(@RequestBody RegistrationRequest registrationRequest) {
        ...
        try {
            ...
            return new ResponseEntity<>(new RestResponse(SggService.APPLICATION_ERROR, e.getMessage()),
